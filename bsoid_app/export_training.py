...
class Export:
    ...
    def __init__(self, working_dir, prefix, sampled_features, assignments, assign_prob, soft_assignments):
        self.options = ['List of pose-relationship features', 'Mapping between features and assignment',
                        'Assignment probabilities'], ['Mapping between features and assignment']
        try:
            ...
            print('Cannot find training, please complete all the necessary steps')
